...
def evalute(args, model, tokenizer, prefix=""):
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
        eval_dataset = load_and_cache_examples(args, eval_task, tokenizer, evalute=True)
...
def load_and_cache_examples(args, task, tokenizer, evaluate=False):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        examples = (
            processor.get_dev_examples(args.data_dir) if evalute else processor.get_train_examples(args.data_dir)
        )
...
def main():
    ...
    parser.add_argument("--learing_rate", default=5e-5, type=float, help="The initial learning rate for Adam.")
    ...
    parser.add_argument("--save_steps", type=int, default=500, help="Save checkpoint evert X updates steps.")
    parser.add_argument(
